...
def LoadData(filename: str, No_iterations: int, initial_size: int):
    ...
    X, Xv, Y, Yv = train_test_split(X, Y, test_size=0.1, random_state=3)
...
def main(No_iterations=20, initial_size=240):
    filename_dat = 'data/n4data.h5'
    # Read data
    ...
    Trees = RFR(n_estimators=100, max_features=5, max_depth=None,
...
if __name__ == '__main__':
    main(60) #Running for 20 AL-iterations
