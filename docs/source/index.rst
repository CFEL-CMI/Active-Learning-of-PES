...
the potential energy surfaces of pyrrole-water molecules. The AL algorithms are:
- Uniform random sampling
- Query-by-Committee (QBC) [SOS1992]_
- A regression version of Stochastic Query by Forest (SQBF) [B2011]_
In both QBC and SQBF we used regression trees as an ensemble of learners. All the algorithms were written based on the
...
and :ref:`implementation-details`, respectively.
